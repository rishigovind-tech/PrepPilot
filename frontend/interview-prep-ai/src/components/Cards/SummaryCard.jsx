...
import { LuBackpack, LuTrash2 } from "react-icons/lu";
...
const SummaryCard = ({
  ...
  return (
    <div
      className="group bg-white border border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100 relative "
      onClick={onSelect}
    >
      <div
      ...
      >
        ...
        <button
          className="hidden group-hover:flex group-hover:bg-red-50  items-center gap-2 text-xs text-rose-500 font-medium px-3 py-1 rounded text-nowrap border border-rose-100 hover:border-rose-200 cursor-pointer absolute top-0 right-0"
          onClick={(e) => {
            e.stopPropagation();
            onDelete();
          }}
