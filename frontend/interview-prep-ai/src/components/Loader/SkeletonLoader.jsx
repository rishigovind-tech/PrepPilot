    ...
    <>
      <div role="status" className="animate-pulse space-y-4 max-w-3xl">
        ...
        <div className="space-y-2">
          ...
          <div className="h-6 bg-gray-200 rounded-md w-10/12"></div>
          <div className="h-6 bg-gray-200 rounded-md w-9/12"></div>
        </div>
      ...
      <div role="status" className="animate-pulse space-y-4 max-w-3xl mt-10">
        ...
        <div className="space-y-2">
          ...
          <div className="h-3 bg-gray-200 rounded-md w-10/12"></div>
          <div className="h-3 bg-gray-200 rounded-md w-9/12"></div>
        </div>
